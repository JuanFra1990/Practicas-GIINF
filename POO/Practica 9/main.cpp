...
int main() {
  ...
  /*
    std::vector<Productos> vprod={// Productos(350,"disco"),
  ...
  */
   ...
   Pedido pedido1, pedido2, pedido3;
    ...
    float importe; 
    Cliente *cliente=0; 
    std::vector<Concepto*> listproductos; 
    Empleado *trabajador;
    
    
    std::vector<Pedido> vpedido;
    
    Pedido ped1(fecha,estado,gastosdeenvio,importe,cliente,listproductos,trabajador);
    Pedido ped2(fecha,estado,gastosdeenvio,importe,cliente,listproductos,trabajador);
    Pedido ped3(fecha,estado,gastosdeenvio,importe,cliente,listproductos,trabajador);

    vpedido.push_back(ped1); 
    vpedido.push_back(ped2); 
    vpedido.push_back(ped3); 

    
    /*Practica 8*/
       
    std::vector<itemCSV*> vpersonas;
   ...
   // UtilesItemCSV::AlmacenaObjetosCSV(vpersonas,numObjs,nomArchivo);
    ...
    listproductos.push_back(concept);
    
    std::vector<Productos *> vprod;
    
    vprod[0]= new Servicio(30,"camara",20,"Uso de la camara");
    vprod[1]= new Articulo(230,"pantalla",20,1);
   // vprod[2]= new ArticuloAlquilable(30,"camara",50,10,20,"Uso de la camara");
